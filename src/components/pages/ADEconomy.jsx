...
import BannerImg from '../../images/ADEconomyImg/ADEconomy.jpg'
import ADEcoBanner from '../../images/ADEconomyImg/ADEcoBanner.png'
import ADQEconomy from '../../images/ADEconomyImg/ADQEconomy.png'
import speakerImg4 from '../../images/SpeakerImg/speakerImg4.png'

const ADEconomy = ({ navigation }) => {
    const handlePress = () => {
        ...
        <View style={{ flex: 1,backgroundColor: '#F4F4F4', width: width }}>
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <View>
                    ...
                    <View style={[styles.container, { marginTop: 20 }]}>
                        <View style={{ width: width / 1 - 32 }}>
                            <Image source={ADEcoBanner} resizeMode='stretch' style={{ width: width / 1 - 32, height: height / 1.5 }} />
                        </View>
                    </View>
                    ...
                    <View style={[styles.container, { marginTop: 20 }]}>
                        <View style={{ width: width / 1 - 32 }}>
                            <View style={styles.container}>
                                <Image source={ADQEconomy} resizeMode='stretch' style={{ width: width / 1.6, height: height / 5 }} />
                            </View>
                        </View>
                    </View>
                        ...
                        <View style={{ width: width / 1 - 28 }}>
                            <View style={{ flexDirection: 'row', gap: 10 }}>
                                <View style={[styles.speakCard, { width: width / 2 - 20 }]}>
                                    <Image source={speakerImg4} resizeMode='stretch' />
